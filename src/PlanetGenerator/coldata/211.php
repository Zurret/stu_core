...
$bonusdata = [PlanetGenerator::BONUS_AENERGY, PlanetGenerator::BONUS_HABITAT, PlanetGenerator::BONUS_HABITAT];
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '601'];
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '601'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '402'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '601'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '702'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '601'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '611'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
...
$uphase[$uphases][PlanetGenerator::COLGEN_FROM] = ['0' => '803'];
$uphase[$uphases][PlanetGenerator::COLGEN_TO] = ['0' => '821'];
...
$uphase[$uphases][PlanetGenerator::COLGEN_FROM] = ['0' => '803'];
$uphase[$uphases][PlanetGenerator::COLGEN_TO] = ['0' => '813'];
$uphase[$uphases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$uphase[$uphases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$uphase[$uphases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
