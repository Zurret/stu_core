...
$bonusdata = [PlanetGenerator::BONUS_AENERGY, PlanetGenerator::BONUS_AENERGY, PlanetGenerator::BONUS_HABITAT];
...
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '713'];
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '713'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '703'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = [401, 713];
$phase[$phases][PlanetGenerator::COLGEN_TO] = [403, 404];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [401, 403, 404];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$ophase[$ophases][PlanetGenerator::COLGEN_TO] = ['0' => '913'];
...
$uphase[$uphases][PlanetGenerator::COLGEN_FROM] = [802];
$uphase[$uphases][PlanetGenerator::COLGEN_TO] = [801];
