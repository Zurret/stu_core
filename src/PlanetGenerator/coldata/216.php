...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = [221];
$phase[$phases][PlanetGenerator::COLGEN_TO] = [501];
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '501'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '704'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = [221];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = [501];
$phase[$phases][PlanetGenerator::COLGEN_TO] = [511];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$uphase[$uphases][PlanetGenerator::COLGEN_FROM] = [805];
$uphase[$uphases][PlanetGenerator::COLGEN_TO] = [815];
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '221'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '210'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '221'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '222'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 5;
...
$uphase[$uphases][PlanetGenerator::COLGEN_FROM] = [805];
$uphase[$uphases][PlanetGenerator::COLGEN_TO] = [821];
$uphase[$uphases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$uphase[$uphases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$uphase[$uphases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
