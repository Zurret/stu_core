...
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '121'];
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '101'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '201'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = [121];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$ophase[$ophases][PlanetGenerator::COLGEN_TO] = ['0' => '903'];
