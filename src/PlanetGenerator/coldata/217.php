...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '909'];
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '910'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [909];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 1;
$phases++;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '906'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [910];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 1;
$phases++;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '922'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [909];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 1;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '904'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '914'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [904];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 1;
$phases++;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '919'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 2;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '907'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [919];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 1;
$phases++;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '923'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [907];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 1;
$phases++;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '912'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '911'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [912];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 1;
$phases++;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '920'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = [911];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_FRAGMENTATION] = 1;
$phases++;
...
$phase[$phases][PlanetGenerator::COLGEN_NUM] = 1;
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '916'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$phase[$phases][PlanetGenerator::COLGEN_FROM] = ['0' => '918'];
$phase[$phases][PlanetGenerator::COLGEN_TO] = ['0' => '902'];
$phase[$phases][PlanetGenerator::COLGEN_ADJACENT] = 0;
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENT] = ['0' => '902'];
$phase[$phases][PlanetGenerator::COLGEN_NOADJACENTLIMIT] = 0;
...
$uphase[$uphases][PlanetGenerator::COLGEN_FROM] = ['0' => '828'];
$uphase[$uphases][PlanetGenerator::COLGEN_TO] = ['0' => '831'];
